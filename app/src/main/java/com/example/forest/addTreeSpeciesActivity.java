...
public class addTreeSpeciesActivity extends AppCompatActivity implements View.OnClickListener {
   ...
   // DatabaseReference databaseReference;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storageReference = FirebaseStorage.getInstance().getReference("Tree");
        ...
        ref.putFile(imageUri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        String treeId = databaseReference.push().getKey();
                        databaseReference.child(treeId).setValue(tree);
