...
public class addBirdSpeciesActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_bird_species);

        databaseReference = FirebaseDatabase.getInstance().getReference("Bird");
        storageReference = FirebaseStorage.getInstance().getReference("Bird");
        ...
        ref.putFile(imageUri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Bird bird = new Bird(name,description,downloadUrl.toString() );
                        //Tree tree = new Tree (description,taskSnapshot.getStorage().getDownloadUrl().toString());
                        String birdId = databaseReference.push().getKey();
                        databaseReference.child(birdId).setValue(bird);
