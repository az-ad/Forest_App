...
public class addReptileSpeciesActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_reptile_species);

        databaseReference = FirebaseDatabase.getInstance().getReference("Reptile");
        storageReference = FirebaseStorage.getInstance().getReference("Reptile");
        ...
        ref.putFile(imageUri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Reptile reptile = new Reptile(name,description,downloadUrl.toString() );
                        //Tree tree = new Tree (description,taskSnapshot.getStorage().getDownloadUrl().toString());
                        String reptileId = databaseReference.push().getKey();
                        databaseReference.child(reptileId).setValue(reptile);
